...
// The global admin's portal role can be neither changed nor removed — the same rule users.ts applies
// to the global admin's user record. Stripping it would lock the portal out; before the bootstrap
