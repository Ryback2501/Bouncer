...
router.post("/", validateBody(createRoleSchema), async (req: Request, res: Response) => {
...
router.patch("/:roleId", validateBody(updateRoleSchema), async (req: Request, res: Response) => {
