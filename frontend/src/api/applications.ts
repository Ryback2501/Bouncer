...
export const createApplication = (data: { name: string; customId: string; redirectUris?: string[] }) =>
  client.post<Application>('/applications', data).then(r => r.data)
export const updateApplication = (id: string, data: { name?: string; customId?: string; redirectUris?: string[] }) =>
